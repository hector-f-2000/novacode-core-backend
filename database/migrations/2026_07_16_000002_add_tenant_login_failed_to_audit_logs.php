...
return new class extends Migration
{
    ...
    {
        DB::statement('ALTER TABLE security_audit_logs DROP CONSTRAINT IF EXISTS security_audit_logs_event_type_check');
        DB::statement("ALTER TABLE security_audit_logs ADD CONSTRAINT security_audit_logs_event_type_check CHECK (event_type::text = ANY (ARRAY['login_success', 'login_failed', 'session_revoked', 'sessions_revoked_all']::text[]))");
    }
};
